        ...
        <?php
         include "functions/loginFunction.php";
           ...
           if (isset($_POST['login'])) {
            $emailAndPhone= $_POST['emailAndPhone'];
            $password=md5($_POST['password']);
             $result= userLogin($emailAndPhone, $password);
           }
            

        ?>
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Email or Phone Number" name="emailAndPhone">
